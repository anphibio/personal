...
const equipmentLibrary = [
  ...
  { id: "supino-declinado", name: "Supino declinado", imageUrl: "assets/equipment/realistic/supino-reto.png", tags: ["supino", "declinado", "bench"] },
  { id: "halteres", name: "Halteres", imageUrl: "assets/equipment/realistic/halteres.png", tags: ["halter", "dumbbell", "peso livre"] },
  { id: "barra-livre", name: "Barra livre", imageUrl: "assets/equipment/realistic/barra-livre.png", tags: ["barra", "olimpica", "peso livre"] },
  { id: "leg-press", name: "Leg press", imageUrl: "assets/equipment/realistic/leg-press.png", tags: ["leg", "45", "prensa"] },
  { id: "hack-squat", name: "Hack squat", imageUrl: "assets/equipment/realistic/hack-squat.png", tags: ["hack", "agachamento hack", "squat"] },
  { id: "smith", name: "Smith machine", imageUrl: "assets/equipment/realistic/smith-machine.png", tags: ["smith", "agachamento guiado"] },
  { id: "cadeira-extensora", name: "Cadeira extensora", imageUrl: "assets/equipment/realistic/cadeira-extensora.png", tags: ["extensora", "quadriceps"] },
  { id: "mesa-flexora", name: "Mesa flexora", imageUrl: "assets/equipment/realistic/mesa-flexora.png", tags: ["flexora", "posterior"] },
  { id: "cadeira-flexora", name: "Cadeira flexora", imageUrl: "assets/equipment/realistic/mesa-flexora.png", tags: ["flexora sentada", "posterior"] },
  { id: "cadeira-adutora", name: "Cadeira adutora", imageUrl: "assets/equipment/realistic/adutora-abdutora.png", tags: ["adutora", "aducao"] },
  { id: "cadeira-abdutora", name: "Cadeira abdutora", imageUrl: "assets/equipment/realistic/adutora-abdutora.png", tags: ["abdutora", "abducao"] },
  { id: "panturrilha-em-pe", name: "Panturrilha em pe", imageUrl: "assets/equipment/realistic/panturrilha.png", tags: ["panturrilha", "gemeos", "calf raise"] },
  { id: "panturrilha-sentado", name: "Panturrilha sentado", imageUrl: "assets/equipment/realistic/panturrilha.png", tags: ["panturrilha", "calf seated"] },
  { id: "gluteo-maquina", name: "Gluteo na maquina", imageUrl: "assets/equipment/realistic/gluteo-maquina.png", tags: ["gluteo", "coice", "kickback"] },
  { id: "crossover", name: "Crossover", imageUrl: "assets/equipment/realistic/crossover.png", tags: ["cross", "cabos", "fly"] },
  { id: "peck-deck", name: "Peck deck", imageUrl: "assets/equipment/realistic/peck-deck.png", tags: ["voador", "fly", "peitoral"] },
  { id: "shoulder-press", name: "Shoulder press", imageUrl: "assets/equipment/realistic/shoulder-press.png", tags: ["desenvolvimento", "ombro", "press"] },
  { id: "puxada-alta", name: "Puxada alta", imageUrl: "assets/equipment/realistic/puxada-alta.png", tags: ["pulley frente", "lat pulldown", "costas"] },
  { id: "pulley-triceps", name: "Pulley triceps", imageUrl: "assets/equipment/realistic/puxada-alta.png", tags: ["triceps corda", "polia", "pulley"] },
  { id: "remada-baixa", name: "Remada baixa", imageUrl: "assets/equipment/realistic/remada-baixa.png", tags: ["remada", "costas", "baixa"] },
  { id: "remada-articulada", name: "Remada articulada", imageUrl: "assets/equipment/realistic/remada-articulada.png", tags: ["remada hammer", "articulada", "costas"] },
  { id: "pullover-maquina", name: "Pullover na maquina", imageUrl: "assets/equipment/realistic/puxada-alta.png", tags: ["pullover", "costas"] },
  { id: "rosca-scott", name: "Rosca scott", imageUrl: "assets/equipment/realistic/halteres.png", tags: ["biceps", "scott"] },
  { id: "rosca-direta", name: "Rosca direta", imageUrl: "assets/equipment/realistic/barra-livre.png", tags: ["biceps", "barra"] },
  { id: "triceps-banco", name: "Triceps banco", imageUrl: "assets/equipment/realistic/supino-reto.png", tags: ["triceps", "mergulho"] },
  { id: "abdominal-maquina", name: "Abdominal na maquina", imageUrl: "assets/equipment/realistic/abdominal-maquina.png", tags: ["abdominal", "core"] },
  { id: "banco-romano", name: "Banco romano", imageUrl: "assets/equipment/realistic/abdominal-maquina.png", tags: ["lombar", "hiperextensao"] },
  { id: "esteira", name: "Esteira", imageUrl: "assets/equipment/realistic/esteira.png", tags: ["cardio", "correr", "caminhada"] },
  { id: "bicicleta", name: "Bicicleta ergometrica", imageUrl: "assets/equipment/realistic/bicicleta.png", tags: ["bike", "cardio", "spinning"] },
  { id: "bicicleta-horizontal", name: "Bicicleta horizontal", imageUrl: "assets/equipment/realistic/bicicleta.png", tags: ["bike recumbent", "horizontal"] },
  { id: "eliptico", name: "Eliptico", imageUrl: "assets/equipment/realistic/eliptico.png", tags: ["transport", "cardio", "elliptical"] },
  { id: "escada", name: "Escada", imageUrl: "assets/equipment/realistic/escada.png", tags: ["stair", "stepmill", "cardio"] }
];
